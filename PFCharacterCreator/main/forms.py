...
class DoteForm(forms.ModelForm):
    ...
    descripcion = forms.CharField(label='Descripcion', required=True, widget=forms.Textarea(attrs={'class': 'form-control h-75', 'placeholder': 'Descripción'}))
    tipo = forms.ChoiceField(choices=TIPO_CHOICES, required=True, widget=forms.Select(attrs={'class': 'form-control', 'placeholder': 'Tipo'}))
    nivel = forms.IntegerField(label='Nivel', initial=1, required=False, widget=forms.NumberInput(attrs={'class': 'form-control w-25', 'placeholder': 'Nivel', 'min':1, 'max':20}))
    ataque_base = forms.IntegerField(label='Ataque base', initial=0, required=False, widget=forms.NumberInput(attrs={'class': 'form-control w-25', 'placeholder': 'Ataque base', 'min':0, 'max':20}))
    fuerza = forms.IntegerField(label='Fuerza', required=False, widget=forms.NumberInput(attrs={'class': 'form-control w-25', 'placeholder': 'Fuerza', 'min':1}))
    destreza = forms.IntegerField(label='Destreza', required=False, widget=forms.NumberInput(attrs={'class': 'form-control w-25', 'placeholder': 'Destreza', 'min':1}))
    constitucion = forms.IntegerField(label='Constitucion', required=False, widget=forms.NumberInput(attrs={'class': 'form-control w-25', 'placeholder': 'Constitución', 'min':1}))
    inteligencia = forms.IntegerField(label='Inteligencia', required=False, widget=forms.NumberInput(attrs={'class': 'form-control w-25', 'placeholder': 'Inteligencia', 'min':1}))
    sabiduria = forms.IntegerField(label='Sabiduria', required=False, widget=forms.NumberInput(attrs={'class': 'form-control w-25', 'placeholder': 'Sabiduría', 'min':1}))
    carisma = forms.IntegerField(label='Carisma', required=False, widget=forms.NumberInput(attrs={'class': 'form-control w-25', 'placeholder': 'Carisma', 'min':1}))
